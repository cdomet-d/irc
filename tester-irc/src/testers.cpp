...
/*   Updated: 2025/03/26 09:52:11 by csweetin        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int
openFile (std::ifstream &expectedOutput, const char *file) {
...
void
compare (std::ifstream &output, std::ifstream &expectedOutput) {
	size_t i = 1;
...
int
test (const char *script, const char *expectedOutputFile,
	  const char *testName) {
	std::ifstream output;
