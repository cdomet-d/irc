...
#define RPL_INVITING(nickname, channel, target)                               \
	(":irc.bitchat.net 341 " + nickname + " " + target + " " + channel        \
	 + "\r\n")
...
#define ERR_BADINPUT(prefix, cmd, expected, received)                         \
	(":" + prefix + " :" + cmd + " format should be [" + expected + "], is [" \
	 + received + "]\r\n")
