...
/*   Updated: 2025/04/10 15:52:16 by cdomet-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define RPL_MYINFO(nickname)                                                   \
	(":irc.bitchat.net 004 " + nickname +                                      \
	 " Bitchat 1.0 o klit klo Bitchat IRC | Modes: o,k,l,i,t | Max nick: "     \
	 "9 "                                                                      \
	 "chars\r\n") // TODO : not used
#define RPL_ISUPPORT(nickname)                                                 \
	":irc.bitchat.net 005 " + nickname +                                       \
		" CHANLIMIT=#:50 CHANMODES=ko,l,it CHANNELLEN=200 CHANTYPES=# "        \
		"NICKLEN=9 USERLEN=18 TARGMAX=JOIN:,KICK:,PART:,PRIVMSG: PREFIX=(o)@ " \
		"TOPICLEN=307 KICKLEN=307 NETWORK=Bitchat :are supported by this "     \
		"server\r\n"
// channel_replies
...
#define REG_COMPLETE(nickname)                                                 \
	(":irc.bitchat.net NOTICE " + nickname +                                   \
	 " :Registration complete! You can join channels and start "               \
	 "chatting.\r\n")
