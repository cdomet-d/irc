...
/*   Updated: 2025/03/26 15:19:06 by aljulien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//standard replies
#define ERR_ALREADYREGISTRED(nickname)                                         \
	(": 462 " + nickname + " :You may not reregister\r\n")
// #define ERR_BADCHANNELKEY(channel) (":475 " + channel + " :Cannot join channel (+k)\r\n")
#define ERR_BADCHANNELKEY(nickname, channel)                                   \
	(": 475 " + nickname + " " + channel + " :Cannot join channel (+k)" +      \
	 "\r\n")
...
#define ERR_CHANOPRIVSNEEDED(nickname, channel)                                \
	(": 482 " + nickname + " " + channel + " :You're not channel operator" +   \
	 "\r\n")
...
#define ERR_NEEDMOREPARAMS(nickname, command)                                  \
	(": 461 " + nickname + " " + command + " :Not enough parameters\r\n")
...
#define ERR_NOSUCHNICK(nickname)                                               \
...
#define RPL_MYINFO(servername, version, umodes, cmodes)                        \
	(": 004 " + servername + " " + version + " " + umodes + " " + cmodes +     \
	 "\r\n")
...
#define ERR_INPUTTOOLONG(nickname)                                             \
	(": 417 " + nickname + " :Input line was too long\r\n")
#define ERR_TOOMANYTARGETS(nickname, target)                                   \
	(": 407 " + nickname + " " + target + " :Too many targets\r\n")
#define ERR_UNKNOWNCOMMAND(nickname, command)                                  \
	(": 421 " + nickname + " " + command + " :Unknown command\r\n")

// Tokenization errors
// #define ERR_ERRONEUSNICKNAME(nickname, badnick) (":432 " + nickname + " " + badnick + " :Erroneous nickname\r\n")

//user define replies
#define NOTICE_REQUIRE_PASSWORD()                                              \
	(":NOTICE : You must provide a password using the PASS command before "    \
	 "registration\r\n")
#define PASS_SUCCESS() (":NOTICE : Valid password ! You may register\r\n")
#define RPL_NICK(nickname)                                                     \
	(":NOTICE : The nickname " + nickname + " is valid and saved !\r\n")
#define RPL_USER(username)                                                     \
	(":NOTICE : The username " + username + " is valid and saved !\r\n")
#define REG_COMPLETE()                                                         \
	(":NOTICE : Registration completed, you can join channels and start "      \
	 "chatting !\r\n")
#define RPL_CHANOPE(channel)                                                   \
	(":NOTICE : You're operator of " + channel + "\r\n")
#define RPL_CHANGEMODE(prefix, channel, mode)                                  \
	(":" + prefix + " MODE " + channel + " " + mode + "\r\n")
#define RPL_INVITE(nickname, target, channel)                                  \
	(":" + nickname + " INVITE " + target + " :" + channel + "\r\n")
#define RPL_JOIN(nickname, channel)                                            \
