...
#define ERR_UNKNOWNCOMMAND(nickname, command)                                  \
  (":irc.bitchat.net 421 " + nickname + " " + command + " :Unknown command\r\n")
...
#define RPL_CREATED(nickname, date)                                            \
  (":irc.bitchat.net 003 " + nickname + " :This server was created " + date +  \
   "\r\n") // TODO : not used
#define RPL_MYINFO(nickname)                                                   \
  (":irc.bitchat.net 004 " + nickname +                                        \
   " Bitchat 1.0 o klit klo Bitchat IRC | Modes: o,k,l,i,t | Max nick: 9 "     \
   "chars\r\n") // TODO : not used
...
#define RPL_NOTOPIC(nickname, channel)                                         \
  (":irc.bitchat.net 331 " + nickname + " " + channel + " :No topic is set" +  \
   "\r\n")
...
#define RPL_USER(nickname, username)                                           \
  (":irc.bitchat.net NOTICE " + nickname + " :The username " + username +      \
   " is valid and saved !\r\n")
#define REG_COMPLETE(nickname)                                                 \
  (":irc.bitchat.net NOTICE " + nickname +                                     \
   " :Registration complete! You can join channels and start chatting.\r\n")
#define RPL_CHANOPE(nickname, channel)                                         \
  (":irc.bitchat.net NOTICE " + nickname + " :You're operator of " + channel + \
   "\r\n")
