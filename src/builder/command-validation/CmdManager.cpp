...
void CmdManager::generateCmds() {
	...
	log(CmdSpec::CmdBuilder()
			.Name("JOIN")
			.Registration(3)
			.Parameters(channel, CmdParam::ParamBuilder().setDelim(",").build())
			.Parameters(
				key, CmdParam::ParamBuilder().isOpt(true).setDelim(",").build())
	...
	log(CmdSpec::CmdBuilder()
			...
			.Registration(3)
			.Parameters(channel, CmdParam::ParamBuilder().build())
			.Parameters(target, CmdParam::ParamBuilder().setDelim(",").build())
