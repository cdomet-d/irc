...
Client::Client(const Client &rhs) { static_cast<void>(rhs); }
...
int Client::getFd() const { return cliFd_; }

const stringVec &Client::getJoinedChans() const { return (joinedChans_); }
...
void Client::setFd(int fd) { cliFd_ = fd; }
